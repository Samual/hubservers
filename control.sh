...
function xon-duel()    { _xon-start-wrapper "$1" "duel"    "16" "27000" "1" "pickup" "duel"             "Duel" "1"; }
function xon-ctf-mh()  { _xon-start-wrapper "$1" "ctf-mh"  "20" "27000" "1" "public" "ctf; minstahook"  "CTF Instagib+Hook" "0"; }
function xon-ctf-wa()  { _xon-start-wrapper "$1" "ctf-wa"  "20" "27000" "1" "public" "ctf; weaponarena" "CTF Weaponarena" "0"; }
function xon-ka-mh()   { _xon-start-wrapper "$1" "ka-mh"   "20" "27000" "1" "public" "ka; minstahook"   "Keepaway Instagib+Hook" "0"; }
